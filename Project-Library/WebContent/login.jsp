...
<body background='img/bg1.jpg' style="background-repeat: no-repeat; background-size:cover; margin: auto;">
                ...
                <fieldset>
                  ...
                  <div class="form-group col-md-12">
                    <div class="input-group input-group-lg">
                        ...
                        <input type="password" class="form-control" name="password" pattern="^[a-z0-9_]{6,18}$" placeholder="密码由字母 数字或下划线组成，6位以上"  required>
                    </div>
                    <span class="help-block with-errors"></span>
                  </div>
