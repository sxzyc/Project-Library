                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-cog"></i> 用户类型</h2>
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="tables">
                                <thead>
                                <a class="btn btn-success" href="userType/userTypePWD">
                                ...
                                <c:forEach var="list" items="${lists}" >
                                    <tr>
                                        ...
                                        <td>${list.power}</td>
                                        <td class="center">
                                            <a class="btn btn-info" href="userType/findById?id=${list.id}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="userType/userTypeDelete?id=${list.id}" data-toggle="modal" data-target="#myModal">
