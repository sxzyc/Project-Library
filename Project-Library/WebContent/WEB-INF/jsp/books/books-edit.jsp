	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form action="books/bookUpdate" method="post" data-toggle="validator">
                   <div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="name">图书条形码*</label>
							<input type="text" class="form-control" name="barcode" value="${books.barcode}" required>
					...
					<div class="form-group">
                            ...
                            <select data-rel="chosen" name="bookTypeid" required>
                            	<c:forEach  var="type" items="${bookTypeLists}">
										<option value="${type.bookTypeid}"
												<c:if test="${type.bookTypeid==books.bookTypeid}">
													selected="selected"
												</c:if>
										>${type.bookTypeName}</option>
									</c:forEach>
                            </select>
                        </div>
                    </div>
					 ...
					 <div class="form-group">
                        <div class="input-group col-md-3">
                            ...
                            <input type="text" class="form-control" pattern="^[0-9]+(\.[0-9]{0,2})?$" data-error="请输入有效的价格" name="price" value="${books.price}" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        <div class="input-group col-md-3">
                            ...
                            <input type="text" class="form-control" pattern="^[0-9]+(\.[0-9]{0,2})?$" data-error="请输入有效的价格" name="count" value="${books.count}" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                       ...
                       <div class="form-group">
						...
						<div class="input-group date form_date col-md-3" data-date="" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">
							<input class="form-control" name="publishDate" type="text" value="${books.publishDate}" readonly required>
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="publish" value="${books.publish}" required/>
							<span class="help-block with-errors"></span>
						</div>
					</div>
					...
					<div class="form-group">
                        <div class="input-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="introduction" value="${books.introduction}">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
...
<script type="text/javascript">
	...
	//var url1="upload/"+${books.bookPhoto}
	//alert(url1);
	//初始化上传控件的样式
    $('#imgEmdImg').fileinput({
  	  	language: 'zh',
...
//  	      actionDelete: '',//去除删除按钮
  	    ...
  	    maxFileCount: 1,
  	  	//initialPreview:"upload/0d98dd6269014ccf955e77d529fef7a2.jpg",
  	  	initialPreviewAsData: true,
  	  	initialPreviewFileType: 'image',
  	  	initialPreview: "<%=basePath %>upload/${books.bookPhoto}",
  	  	//initialPreview: [  
         // "<img src='Book-System3.5/upload/0d98dd6269014ccf955e77d529fef7a2.jpg"+"' class='file-preview-image'>"  
  	  	//"http://localhost:8080/Book-System3.5/upload/0d98dd6269014ccf955e77d529fef7a2.jpg", 
      	//],
		initialPreviewConfig: [ //配置预览中的一些参数   
                  {caption: "transport-1.jpg", size: 329892, width: "120px", url: "<%=basePath %>Photo/Photodelete?filepath={books.bookPhoto}", key: 1},  
    ...
    //同步上传返回结果处理
      $("#imgEmdImg").on('filepredelete', function(event, key, jqXHR, data) {  
    	  alert("删除成功");
		});  
