	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form action="loanInfo/loanInfoAdd" method="post" data-toggle="validator">
                <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="reader" required/>
							<span class="help-block with-errors"></span>
						</div>
                    </div>
                    <div class="form-group">
					...
					<div class="form-group">
						...
						<div class="input-group date form_date col-md-3" data-date="" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">
							<input class="form-control" name="borrowDate" type="text" readonly required>
					...
					<div class="form-group">
						...
						<div class="input-group date form_date col-md-3" data-date="" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">
							<input class="form-control" name="returnDate" type="text" readonly>
							<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
						</div>
						<input type="hidden" id="dtp_input2" value="" /><br/>
					</div>
