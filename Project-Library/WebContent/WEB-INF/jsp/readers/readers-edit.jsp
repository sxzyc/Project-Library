...
<div class="ch-container">
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="reader/readerList"><i class="glyphicon glyphicon-user"></i><span> &ensp;读&ensp;者&ensp;管&ensp;理</span></a></li>
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="reader/readerList">读者管理</a>
        </li>
        <li>
            <a href="#">编辑</a>
        </li>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form action="reader/readerUpdate" method="post" data-toggle="validator">
                   <div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="name">读者编号*</label>
							<input type="text" class="form-control" name="readerNo" value="${reader.readerNo}" required>
                    ...
                    <div class="form-group">
                        <div class="input-group col-md-3">
                            <label class="control-label">读者类别*</label><br>
                            <select data-rel="chosen" name="readerType" required>
                            	<c:forEach  var="type" items="${userTypeLists}">
										<option value="${type.id}"
												<c:if test="${type.id==reader.readerType}">
													selected="selected"
												</c:if>
										>${type.userTypeName}</option>
									</c:forEach>
                            </select>
                        </div>
                    </div>
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="tel">姓名*</label>
							<input type="text" class="form-control" name="readerName" value="${reader.readerName}" required/>
							<span class="help-block with-errors"></span>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="addr">联系电话*</label>
							<input type="text" class="form-control" name="telephone" value="${reader.telephone}" required/>
							<span class="help-block with-errors"></span>
						</div>
					</div>
                    ...
                    <div class="form-group">
                        <div class="input-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="qq" value="${reader.qq}">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <div class="input-group col-md-3">
                            <label class="control-label">读者地址*</label>
                            <input type="text" class="form-control" name="address" value="${reader.address}" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
