...
<div class="ch-container">
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="loanInfo/loanInfoList"><i class="glyphicon glyphicon-list-alt"></i><span> &ensp;借&ensp;阅&ensp;信&ensp;息</span></a></li>
                    </ul>
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="loanInfo/loanInfoList">借阅管理</a>
        </li>
        <li>
            <a href="#">编辑</a>
        </li>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form action="loanInfo/loanInfoEdit" method="post" data-toggle="validator">
                <div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="name">姓名*</label>
							<input type="text" class="form-control" name="name" value="${loanInfo.name}" required/>
                    ...
                    <div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="name">借阅编号*</label>
							<input type="text" class="form-control" name="book" value="${loanInfo.book}" required/>
							<span class="help-block with-errors"></span>
						</div>
                    </div>
                     ...
                     <div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="name">图书对象*</label>
							<input type="text" class="form-control" name="reader" value="${loanInfo.reader}" required/>
							<span class="help-block with-errors"></span>
						</div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group col-md-3">
                            <label class="control-label">借阅状态*</label><br>
                            <select data-rel="chosen" name="status" value="${loanInfo.status}">
                            <option value="${loanInfo.status }">${loanInfo.status }</option>	
					...
					<div class="form-group">
						...
						<div class="input-group date form_date col-md-3" data-date="" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">
							<input class="form-control" name="borrowDate" type="text" value="${loanInfo.borrowDate}" readonly required>
					...
					<div class="form-group">
						...
						<div class="input-group date form_date col-md-3" data-date="" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">
							<input class="form-control" name="returnDate" type="text" value="${loanInfo.returnDate}" readonly>
							<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
						</div>
						<input type="hidden" id="dtp_input2" value="" /><br/>
					</div>

					<input type="hidden" name="loadId"  value="${loanInfo.loadId}">
