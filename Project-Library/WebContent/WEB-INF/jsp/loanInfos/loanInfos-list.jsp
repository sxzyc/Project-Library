                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-cog"></i> 借阅管理</h2>
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="tables">
                                <thead>
                                <a class="btn btn-success" href="loanInfo/loanInfoPWD">
                                ...
                                <tbody>
                                <c:forEach var="loanInfo" items="${loanInfos}" >
                                    <tr>
                                        <td>${loanInfo.loadId}</td>
                                        <td>${loanInfo.name}</td>
                                        <td>${loanInfo.book}</td>
                                        <td>${loanInfo.reader}</td>
                                        <td>${loanInfo.status}</td>
                                        <td>${loanInfo.borrowDate}</td>
                                        <td>${loanInfo.returnDate}</td>
                                        <td class="center">
                                            <a class="btn btn-info" href="loanInfo/findById?id=${loanInfo.loadId}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="loanInfo/loanInfoDelete?id=${loanInfo.loadId}" data-toggle="modal" data-target="#myModal">
