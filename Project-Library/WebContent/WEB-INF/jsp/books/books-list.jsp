                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-cog"></i> 图书信息</h2>
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="tables">
                                <thead>
                                <a class="btn btn-success" href="books/bookPWD">
                                ...
                                <c:forEach var="list" items="${lists}" >
                                    <tr>
                                        ...
                                        <td>${list.barcode}</td>
                                        <td>${list.bookName}</td>
                                        <td><c:forEach var="type" items="${bookTypeLists}">
												<c:if test="${type.bookTypeid==list.bookTypeid}">
												${type.bookTypeName}
												</c:if>
										</c:forEach></td>
                                        <td>${list.price}</td>
                                        ...
                                        <td><img width="55px" height="45px"
                                         src="<%=basePath %>upload/${list.bookPhoto}"></td>
                                         
                                        <td class="center">
                                            <a class="btn btn-info" href="books/findById?id=${list.id}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="books/bookDelete?id=${list.id}" data-toggle="modal" data-target="#myModal">
