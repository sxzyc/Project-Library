	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form action="bookTypes/bookTypeAdd" method="post" data-toggle="validator">					
					<div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="tel">图书类别*</label>
							<input type="text" class="form-control" name="bookTypeName" required/>
                     ...
                     <div class="form-group">
                        <div class="input-group col-md-3">
                            ...
                            <input type="text" class="form-control" pattern="^[0-9]+(\.[0-9]{0,2})?$" data-error="请输入有效的天数" name="days" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
