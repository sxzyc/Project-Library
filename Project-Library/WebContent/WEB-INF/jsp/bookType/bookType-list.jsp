                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-cog"></i> 图书类型</h2>
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="tables">
                                <thead>
                                <a class="btn btn-success" href="bookTypes/bookTypePWD">
                                ...
                                <c:forEach var="list" items="${lists}" >
                                    <tr>
                                        <td>${list.bookTypeid}</td>
                                        <td>${list.bookTypeName}</td>
                                        <td>${list.days}</td>
                                        <td class="center">
                                            <a class="btn btn-info" href="bookTypes/findById?id=${list.bookTypeid}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="bookTypes/bookTypeDelete?id=${list.bookTypeid}" data-toggle="modal" data-target="#myModal">
