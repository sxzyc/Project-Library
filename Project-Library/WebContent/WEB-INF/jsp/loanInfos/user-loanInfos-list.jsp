                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="javascript:location.href='<%=basePath %>loanInfo/userloanInfoList?readername='+encodeURIComponent('${userReader.readerName }');"><i class="glyphicon glyphicon-list-alt"></i><span> &ensp;借&ensp;阅&ensp;信&ensp;息</span></a></li>                          
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:location.href='<%=basePath %>loanInfo/userloanInfoList?readername='+encodeURIComponent('${userReader.readerName }');">借阅信息</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-cog"></i> 借阅信息</h2>
