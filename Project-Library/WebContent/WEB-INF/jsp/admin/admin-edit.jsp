	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form action="user/adminEdit" method="post" data-toggle="validator">
                    <div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="name">姓名*</label>
							<input type="text" class="form-control" name="username" value="${readmin.username}" required/>
					...
					<input type="hidden" name="id"  value="${readmin.id}">
