                    ...
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="tables">
                                <thead>
                                <a class="btn btn-success" href="reader/readerPWD">
                                ...
                                <c:forEach var="reader" items="${readers}" >
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a class="btn btn-info" href="reader/findById?id=${reader.id}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="reader/readerDelete?id=${reader.id}" data-toggle="modal" data-target="#myModal">
