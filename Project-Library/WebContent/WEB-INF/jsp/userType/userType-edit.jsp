	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form action="userType/userTypeUpdate" method="post" data-toggle="validator">		
					<div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="tel">用户类型*</label>
							<input type="text" class="form-control" name="userTypeName" value="${userType.userTypeName}" required/>
                    ...
                    <div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="power" value="${userType.power}" required/>
							<span class="help-block with-errors"></span>
						</div>
					</div>
