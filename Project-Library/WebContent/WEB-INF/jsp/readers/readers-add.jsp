	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form action="reader/readerAdd" method="post" data-toggle="validator">
                    <div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="name">读者编号*</label>
							<input type="text" class="form-control" name="readerNo"  required>
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="readerName" required/>
							<span class="help-block with-errors"></span>
						</div>
					</div>
